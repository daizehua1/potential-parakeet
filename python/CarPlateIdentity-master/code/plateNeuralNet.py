...
class plate_cnn_net:
    def __init__(self):
        ...
        self.x_place = tf.placeholder(dtype=tf.float32, shape=[None, self.img_h, self.img_w, 3]
                                     , name='x_place')
    ...
    def cnn_construct(self):
        ...
        conv1 = tf.nn.relu(tf.nn.bias_add(tf.nn.conv2d(x_input, filter=cw1, strides=[1, 1, 1, 1],
                                                       padding='SAME'), cb1))
        ...
        conv2 = tf.nn.relu(tf.nn.bias_add(tf.nn.conv2d(conv1, filter=cw2, strides=[1, 1, 1, 1],
                                                       padding='SAME'), cb2))
        ...
        conv3 = tf.nn.relu(tf.nn.bias_add(tf.nn.conv2d(conv2, filter=cw3, strides=[1, 1, 1, 1],
                                                       padding='SAME'), cb3))

...
def get_plate():
    parking_space = request.values["parking_space"]
    save_path = request.values["save_path"]
    print(save_path)
    cur_dir = sys.path[0]
    ...
    cv2.imwrite(r'E:\python_object\car_parking\houtai\static\media\plate_place\plate.jpg', car_plate)
    # 判断车牌的颜色
